...
**<span style="color: rgb(255, 76, 65);">Tip 2:</span>** We also provide you with the latest Micro:bit firmware-0255 .hex file: [Micro:bit_Firmware](./Microbit_Firmware.zip).
